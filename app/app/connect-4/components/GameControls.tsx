    ...
    return (
        ...
        >
            ...
            <Link href="/" className="flex-1">
                <button className="w-full px-6 py-3 rounded-xl bg-zinc-800 text-white font-medium hover:bg-zinc-700 border border-zinc-700">
                Return to Games
                </button>
            </Link>

            {/* Current Player / Winner Display */}
            <div className="flex-1 w-full px-6 py-3 rounded-xl bg-black/70 backdrop-blur-sm border-2 border-purple-500/30 text-center">
            ...
            <button
                ...
                className="flex-1 px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-500 to-pink-500 text-white font-semibold hover:from-cyan-600 hover:to-pink-600"
            >
